! function (e, t) {
  ...
  return function (e) {
    ...
    function s(e, t) {
      var i, n, r = l[e].api;
      if (b) {
        if (f.isUCBrowser && (w[e] && (i = f.isIOS ? w[e][0] : w[e][1]), void 0 !== i)) return n = [t.title, t.digest, t.url, i, "", "@" + t.from, ""], window.ucweb && ucweb.startRequest && ucweb.startRequest("shell.page_share", n), void(window.ucbrowser && ucbrowser.web_share && ucbrowser.web_share.apply(null, n));
        if (f.isQQBrowser && (w[e] && (i = w[e][2]), void 0 !== i)) return void(window.browser ? (n = {
          ...
          to_app: i,
          cus_txt: ""
        }, browser.app && browser.app.share(n)) : c("//jsapi.qq.com/get?api=app.share", function () {
          s(e, t)
        }))
      }
      if ("qzone" === e || "qq" === e) {
    ...
    function c(e, t) {
      ...
      i.src = e, i.onload = onreadystatechange = function () {
    ...
    function d(e) {
      if (f.isIOS) window.location.href = e;
        ...
        t.style.display = "none", t.src = e, g.appendChild(t), setTimeout(function () {
    ...
    o.popIn = function (e) {
      ...
      i.classList.remove("soshm-pop-hide"), i.style.display = "block", setTimeout(function () {
        i.classList.add("soshm-pop-show")
      }.bind(this), 0), i.addEventListener("click", function () {
        i.classList.remove("soshm-pop-show"), i.classList.add("soshm-pop-hide"), setTimeout(function () {
          i.style.display = "none", t.destroy()
        }, 1100)
      }, !1)
      ...
      if ("number" !== r(e) && (e = 2e3), f.isWeixin) {
        ...
        t.classList.add("weixin-sharetip-show"), setTimeout(function () {
    ...
    function i(e) {
      return e = e.toLowerCase(), s.indexOf(e) !== -1
    }
    ...
    function s(e, t, i, o) {
      return function (i) {
        i.delegateTarget = n(i.target, t), i.delegateTarget && o.call(e, i)
      }
    }
    var n = i(4);
    e.exports = o
    ...
    var i = {
      ...
      _utf8_decode: function (e) {
        for (var t = "", i = 0, o = c1 = c2 = 0; i < e.length;) o = e.charCodeAt(i), o < 128 ? (t += String.fromCharCode(o), i++) : o > 191 && o < 224 ? (c2 = e.charCodeAt(i + 1), t += String.fromCharCode((31 & o) << 6 | 63 & c2), i += 2) : (c2 = e.charCodeAt(i + 1), c3 = e.charCodeAt(i + 2), t += String.fromCharCode((15 & o) << 12 | (63 & c2) << 6 | 63 & c3), i += 3);
        return t
      }
    };
    e.exports = i
