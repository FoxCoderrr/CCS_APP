    ...
    <div class="forget">
        ...
        <div class="form form1">
            ...
            <div class="div ovh mt30">
                ...
                <x-input class="fl" type="password"  v-model="pwd" placeholder="请输入新密码(至少6位数字或字母)"></x-input>
            </div>
            <div class="div ovh mt30">
                <span class="fl iconfont icon-icon_password_yes"></span>
                <x-input class="fl" type="password"  v-model="pwd1" placeholder="请再次输入密码"></x-input>
            </div>
